# -*- coding: utf-8 -*-
"""
Created on Thu Mar 15 19:13:09 2018

Geo-Python Lesson 6 walk-through continued
...
data = pd.read_csv('August.txt', sep='\s+', na_values=['*', '**', '***', '****', '*****', '******'] )
...
### check and see how many stormy observations for x hour of day using valuecounts()
print(storm['TIME_h'].value_counts())

### sort by strongest wind gust
